...
T1._Q_000_F_005',N'@P1 nvarchar(4000),@P2 numeric(10),@P3 numeric(10),@P4 numeric(10),@P5 numeric(10),@P6 numeric(10),@P7 numeric(10),@P8 nvarchar(4000),@P9 numeric(10),@P10 numeric(10),@P11 numeric(10),@P12 numeric(10),@P13 numeric(10),@P14 numeric(10),@P15 numeric(10)',N'denso',0,0,0,0,0,0,N'Отчет продажи фитнес',0,0,0,0,0,0,0
